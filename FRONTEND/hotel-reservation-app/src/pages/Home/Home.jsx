...
function Home() {
  ...
  const alojamientosPaginados = todosLosAlojamientos.slice(
    indexInicio,
    indexFin
  );

  const totalPaginas = Math.ceil(
    todosLosAlojamientos.length / alojamientosPorPagina
  );
  ...
  return (
    <main className="main-content container">
      ...
      <section className="search-section">
        <h1 className="my-2 highlighted-title">
          Busca tu alojamiento en Trenque Lauquen
        </h1>
        <SearchBar />
      </section>
      ...
      <div className="d-flex flex-column flex-md-row">
        ...
        <section className="recommendations-section flex-grow-1">
          <h2 className="text-center highlighted-title">
      ...
      <section className="available-section mt-5">
        <div className="container">
          <h2 className="text-center mb-4 highlighted-title">
            Alojamientos disponibles
          </h2>
